...
lq q task -g ResilioLogseq -C|grep -e "InsideToDo"  | sort | sed 's/- TODO #InsideToDo //g' >> ~/Downloads/logseq_tasks.txt
echo " " >> ~/Downloads/logseq_tasks.txt
...
lq q task -g ResilioLogseq -C|grep  -e "OutsideTodo" | sort | sed 's/- TODO #OutsideTodo //g' >> ~/Downloads/logseq_tasks.txt
echo " " >> ~/Downloads/logseq_tasks.txt
...
lq q task -g ResilioLogseq -C|grep -e  "ResearchToDo" | sort | sed 's/- TODO #ResearchToDo //g' >> ~/Downloads/logseq_tasks.txt
